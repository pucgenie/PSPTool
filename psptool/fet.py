...
class Fet(NestedBuffer):
    ...
    def __init__(self, parent_buffer, fet_offset: int, agesa_version):
        ...
        #TODO: Don't assume this offset
        self.fet = NestedBuffer(self, self.fet_size, buffer_offset=Fet._FIRMWARE_ENTRY_TABLE_BASE_ADDRESS)
    ...
    def _determine_rom(self):
        ...
        self.blob_offset = self.fet_offset - Fet._FIRMWARE_ENTRY_TABLE_BASE_ADDRESS #TODO don't assume this offset
